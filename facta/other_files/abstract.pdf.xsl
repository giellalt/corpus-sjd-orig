...
<xsl:variable name="filename" select="'abstract'"/>
<xsl:variable name="text_encoding" select="'UTF-8'"/>
<xsl:variable name="title" select="'оаньхесь кыррьй – юӧртом'"/>
...
<xsl:variable name="place" select="'Murmansk'"/>
...
<xsl:variable name="mlang_kom" select="'1'"/>
<xsl:variable name="mlang_sjd" select="'1'"/>

<!-- If the document has parallel texts, select "1" for parallel_texts -->
<!-- Add the locations of the parallel files to the variables-->
<xsl:variable name="parallel_texts" select="''"/>
<xsl:variable name="para_kom" select="''"/>
<xsl:variable name="para_sjd" select="''"/>
