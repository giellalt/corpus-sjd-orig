...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="publChannel" select="'journal'"/>
    <xsl:variable name="year" select="'2010'"/>
    <xsl:variable name="ISBN" select="''"/>
    <xsl:variable name="ISSN" select="''"/>
    <xsl:variable name="place" select="'Мурманск'"/>
    <xsl:variable name="genre" select="'science'"/>
    <xsl:variable name="collection" select="'Наука и бизнес на Мурмане'"/>
