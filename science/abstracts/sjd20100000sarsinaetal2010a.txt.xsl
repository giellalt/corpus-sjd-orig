...
<xsl:variable name="title" select="'Oan'xes' kyrr'j'"/>
<xsl:variable name="author1_fn" select="'Nina'"/>
<xsl:variable name="author1_ln" select="'Sharshina'"/>
<xsl:variable name="author1_gender" select="'unknown'"/>
<xsl:variable name="author1_nat" select="''"/>
<xsl:variable name="author1_born" select="''"/>
<xsl:variable name="author2_fn" select="'Valentina'"/>
<xsl:variable name="author2_ln" select="'Kirilova'"/>
<xsl:variable name="author2_gender" select="''"/>
<xsl:variable name="author2_nat" select="''"/>
<xsl:variable name="author2_born" select="''"/>
<xsl:variable name="author3_fn" select="'Alla'"/>
<xsl:variable name="author3_ln" select="'Vasiljeva'"/>
<xsl:variable name="author3_gender" select="''"/>
<xsl:variable name="author3_nat" select="''"/>
<xsl:variable name="author3_born" select="''"/>
<xsl:variable name="author4_fn" select="'Sanndre'"/>
<xsl:variable name="author4_ln" select="'Antonova'"/>
...
<xsl:variable name="collection" select="'Nauka i biznes na Murmane'"/>
